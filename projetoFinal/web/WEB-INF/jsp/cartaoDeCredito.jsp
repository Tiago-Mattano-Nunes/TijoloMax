            ...
            <div class="enderecos">           
                <form action="calcular" enctype="multipart/form-data" method="post" >
                    ...
                    <div>
                        ...
                        <input type="text" id="numeroC" name="numero" maxlength="16" minlength="16" required>
                    </div>
                    <div>
                        <h3>CVV:</h3>
                    ...
                    <div>
                        <h3>Vencimento:</h3>
                        <input type="text" id="vencimento" name="vencimento" maxlength="4" minlength="4" required>
                    </div>
